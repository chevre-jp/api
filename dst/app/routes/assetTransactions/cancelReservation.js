...
cancelReservationTransactionsRouter.post('/start', permitScopes_1.default(['assetTransactions.cancelReservation.write', 'assetTransactions.write']), ...[
...
cancelReservationTransactionsRouter.post('/confirm', permitScopes_1.default(['assetTransactions.cancelReservation.write', 'assetTransactions.write']), ...[
    express_validator_1.body('project')
        .not()
        .isEmpty()
        .withMessage('required'),
...
cancelReservationTransactionsRouter.put('/:transactionId/confirm', permitScopes_1.default(['assetTransactions.cancelReservation.write', 'assetTransactions.write']), validator_1.default, (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const projectRepo = new chevre.repository.Project(mongoose.connection);
        const taskRepo = new chevre.repository.Task(mongoose.connection);
        const transactionRepo = new chevre.repository.AssetTransaction(mongoose.connection);
...
cancelReservationTransactionsRouter.put('/:transactionId/cancel', permitScopes_1.default(['assetTransactions.cancelReservation.write', 'assetTransactions.write']), validator_1.default, (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const transactionRepo = new chevre.repository.AssetTransaction(mongoose.connection);
