...
movieTheaterRouter.post('', permitScopes_1.default(['admin']), ...[
    ...
    try {
        ...
        const movieTheater = Object.assign({}, req.body, { typeOf: chevre.factory.placeType.MovieTheater, project: project });
...
movieTheaterRouter.put('/:branchCode', permitScopes_1.default(['admin']), ...[
    check_1.body('name')
        .not()
        .isEmpty()
], validator_1.default, (req, res, next) => __awaiter(this, void 0, void 0, function* () {
    try {
        const movieTheater = Object.assign({}, req.body, { typeOf: chevre.factory.placeType.MovieTheater, branchCode: req.params.branchCode });
        const placeRepo = new chevre.repository.Place(mongoose.connection);
        yield placeRepo.saveMovieTheater(movieTheater);
