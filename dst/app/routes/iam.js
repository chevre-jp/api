 ...
 * プロフィール検索
 */
iamRouter.get('/users/:id/profile', permitScopes_1.default([]), (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const personRepo = new chevre.repository.Person({
            userPoolId: ADMIN_USER_POOL_ID
        });
 ...
 * プロフィール更新
 */
iamRouter.patch('/users/:id/profile', permitScopes_1.default([]), validator_1.default, (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const personRepo = new chevre.repository.Person({
            userPoolId: ADMIN_USER_POOL_ID
        });
