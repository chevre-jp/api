 ...
 * プロジェクトメンバー追加
 */
iamMembersRouter.post('', permitScopes_1.default(['iam.members.write']), ...[
 ...
 * プロジェクトメンバープロフィール取得
 */
iamMembersRouter.get('/:id/profile', permitScopes_1.default(['iam.members.profile.read']), (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const memberRepo = new chevre.repository.Member(mongoose.connection);
        const members = yield memberRepo.search({
            member: { id: { $eq: req.params.id } },
 ...
 * プロジェクトメンバープロフィール更新
 */
iamMembersRouter.patch('/:id/profile', permitScopes_1.default(['iam.members.profile.write']), validator_1.default, (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const memberRepo = new chevre.repository.Member(mongoose.connection);
        const members = yield memberRepo.search({
            member: { id: { $eq: req.params.id } },
